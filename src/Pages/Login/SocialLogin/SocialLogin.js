  ...
  return (
    <div>
      <div className="d-flex align-items-center ">
        <div
          style={{ height: "1px " }}
          className="bg-light w-50 text-center"
        ></div>
      ...
      <div className="d-block">
        <div>
          <button
            ...
            className="btn btn-light w-50 py-2 d-block mx-auto "
          >
            <img src={google} alt="" />
        ...
        <div>
          <button
            ...
            className="btn btn-light  w-50 my-2 d-block mx-auto "
          >
            <img src={github} alt="" />
        ...
        <div>
          <button
            ...
            className="btn btn-light button-group w-50 d-block mx-auto"
          >
